    ...
    static validateIsProviderDriver(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                errorHandler_1.default.throwErrorIfNull(provider, `Provider with id ${providerId} does not exist`);
                errorHandler_1.default.throwErrorIfNull(driver, `Driver with id ${driverId} does not exist`);
                const isProviderDriver = yield provider.hasDriver(driver);
                if (!isProviderDriver) {
                    const errorPayload = {
                        message: 'Sorry, driver does not belong to the provider',
                        statusCode: 400,
                    };
                    return errorHandler_1.default.sendErrorResponse(errorPayload, res);
                }
                res.locals = { driver };
            }
            catch (error) {

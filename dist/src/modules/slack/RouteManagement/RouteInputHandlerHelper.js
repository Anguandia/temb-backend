...
class RouteInputHandlerHelper {
    static saveRouteRequestDependencies(userId, teamId, submissionValues) {
        return __awaiter(this, void 0, void 0, function* () {
            const { busStop: { longitude: busStopLng, latitude: busStopLat, address: busStopAddress }, homeAddress: { longitude: homeLng, latitude: homeLat, address: homeAdd }, } = yield cache_1.default.fetch(userId);
    ...
    static getLocationDetailsFromCache(payload, key, coordinateValue = null) {
        return __awaiter(this, void 0, void 0, function* () {
            const locationResult = (yield cache_1.default.fetch(payload.user.id))[`${key}`];
            if (coordinateValue) {
    ...
    static resolveDestinationPreviewData(payload, busStopCoordinate) {
        return __awaiter(this, void 0, void 0, function* () {
            const [staticMapString, savedHomeAddress, savedBusStop, theDojo] = yield Promise.all([
                ...
                RouteInputHandlerHelper.getLocationDetailsFromCache(payload, 'busStageList', busStopCoordinate),
    ...
    static savePreviewDataToCache(key, previewData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield cache_1.default.save(key, 'busStop', savedBusStop);
            yield cache_1.default.save(key, 'locationInfo', locationInfo);
        });
    }
    static continueWithTheFlow(payload, respond) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            RouteInputHandler_1.default.home(newPayload, respond);
        });
    }
    static checkIfAddressExistOnDatabase(payload, respond, locationSearchString) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (resultFromDatabase.length > 0) {
                yield cache_1.default.save(payload.user.id, 'newRouteRequest', locationSearchString);
    ...
    static cacheLocationAddress(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield cache_1.default.save(payload.user.id, 'homeAddress', {
    ...
    static generateResolvedBusList(busStageList, location, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield cache_1.default.save(payload.user.id, 'busStageList', filteredBusStops);

...
class DialogPrompts {
    ...
    static sendSelectProviderDialog(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            dialog.addElements([
                new SlackDialogModels_1.SlackDialogSelectElementWithOptions('Select A Provider', 'provider', [...providerData]),
                new SlackDialogModels_1.SlackDialogTextarea('Justification', 'confirmationComment', 'Reason why', 'Enter reason for approving trip')
            ]);
            yield DialogPrompts.sendDialog(dialog, payload);
        });
    }
    ...
    static sendBusStopForm(payload, busStageList) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            dialog.addElements([
                new SlackDialogModels_1.SlackDialogText('Landmark not listed?', 'otherBusStop', 'latitude,longitude', true, 'The location should be in the format (latitude, longitude), eg. -0.234,23.234'),
            ]);
            yield DialogPrompts.sendDialog(dialog, payload);
        });
    }
    ...
    static sendLocationCoordinatesForm(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            const dialog = new SlackDialogModels_1.SlackDialog('new_route_suggestions', 'Home address coordinates', 'Submit', true);
            const hint = 'e.g -1.219539, 36.886215';
            dialog.addElements([
                new SlackDialogModels_1.SlackDialogText('Address coordinates:', 'coordinates', 'Type in your home address latitude and longitude', false, hint)
            ]);
            yield DialogPrompts.sendDialog(dialog, payload);
        });
    }

...
const { TokenValidator, CabsValidator, GeneralValidator } = middlewares_1.default;
const cabsRouter = express_1.Router();
cabsRouter.use(TokenValidator.attachJwtSecretKey.bind(TokenValidator), TokenValidator.authenticateToken.bind(TokenValidator));
cabsRouter.post('/cabs', CabsValidator.validateAllInputs, CabsController_1.default.createCab);

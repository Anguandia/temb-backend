...
const routes = (app) => {
    app.use('/api/v1/', verify_provider_1.default);
    ...
    app.use(apiPrefix, authentication_1.default);
    ...
    apiSpec_1.setupSwaggerUI(app, '/docs/v1', apiSpec_1.v1JSDoc, apiDocsOptions);
    return app;
};

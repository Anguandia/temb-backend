...
const { GeneralValidator, RouteValidator, TokenValidator, RouteRequestValidator, mainValidator, } = middlewares_1.default;
const routesRouter = express_1.default.Router();
routesRouter.use('/routes', TokenValidator.attachJwtSecretKey.bind(TokenValidator), TokenValidator.authenticateToken.bind(TokenValidator));
...
routesRouter.put('/routes/requests/status/:requestId', RouteRequestValidator.validateRequestBody, RouteRequestValidator.validateParams, RouteController_1.default.updateRouteRequestStatus);

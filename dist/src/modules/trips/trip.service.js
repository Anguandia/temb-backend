...
class TripService extends base_service_1.BaseService {
    constructor(model = database_1.default.getRepository(database_1.TripRequest)) {
        super(model);
        this.defaultInclude = [
            { model: database_1.Provider, include: ['user'] },
            { model: database_1.Homebase, include: ['country'] },
    ...
    getTrips(pageable, where, homebaseId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const defaultOptions = this.createFilter(Object.assign(Object.assign({}, where), { homebaseId }));

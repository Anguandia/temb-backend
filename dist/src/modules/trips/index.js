...
const { TripValidator, TokenValidator, GeneralValidator, } = middlewares_1.default;
const tripsRouter = express_1.Router();
tripsRouter.use('/trips', TokenValidator.attachJwtSecretKey.bind(TokenValidator), TokenValidator.authenticateToken.bind(TokenValidator));

...
const { TokenValidator, mainValidator } = middlewares_1.default;
const { readDepartmentRecords } = ValidationSchemas_1.default;
departmentRouter.use('/departments', TokenValidator.attachJwtSecretKey.bind(TokenValidator), TokenValidator.authenticateToken.bind(TokenValidator));

...
exports.SlackInstallUrl = `https://slack.com/oauth/authorize?client_id=${process.env.SLACK_CLIENT_ID}&scope=team:read,chat:write:bot,chat:write:user,bot,commands,users.profile:read,users:read.email,users:read,incoming-webhook,groups:read`;
class HomeController {
    ...
    static convertJSONResponseToTeamDetailsObj(jsonResponse) {
        const urlObject = url_1.default.parse(jsonResponse.incoming_webhook.configuration_url);

...
class NewSlackHelpers {
    ...
    static getDestinationFields(homeBaseName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const destinationField = new SlackDialogModels_1.SlackDialogSelectElementWithOptions('Destination location', 'destination', locations);

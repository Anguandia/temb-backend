...
class TravelTripController {
    ...
    embassyVisit(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.cache.save(TravelTripHelper_1.getTravelKey(payload.user.id), 'tripType', trip_request_1.TripTypes.embassyVisit);
            yield this.interactions.sendContactDetailsModal(payload);
        });
    }
    airportTransfer(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.cache.save(TravelTripHelper_1.getTravelKey(payload.user.id), 'tripType', trip_request_1.TripTypes.airportTransfer);
            yield this.interactions.sendContactDetailsModal(payload);
        });
    }
    ...
    submitContactDetails(payload, submission, respond, context) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const tripDetailsModal = yield this.travelHelpers.getTripDetailsModal(payload);
                const flightDetailsModal = yield this.travelHelpers.getFlightDetailsModal(payload);
                const { tripType } = yield this.cache.fetch(TravelTripHelper_1.getTravelKey(payload.user.id));

...
class TravelHelpers {
    ...
    getTripDetailsModal(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            const { destinationSelect, pickupSelect, } = yield this.getTripDetailsSelects(payload);
            ...
            const appointmentDate = new slack_block_models_1.InputBlock(new slack_block_models_1.DatePicker(defaultDate, 'select a date', 'date'), 'Interview Date', 'date');
            const appointmentTime = new slack_block_models_1.InputBlock(new slack_block_models_1.TextInput('HH:mm', 'time'), 'Interview Time', 'time');
            const textarea = new slack_block_models_1.InputBlock(new slack_block_models_1.TextInput('Enter reason for booking the trip', 'reason', true), 'Reason', 'reason');
            return new slack_block_models_1.Modal('Trip Details', {
                submit: 'Submit',
                close: 'Cancel',
    ...
    createTravelSummary(tripPayload, userSlackId, useActions, customActions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const hoursBefore = tripType === 'Airport Transfer' ? 3 : 2;
            const trip = tripType === 'Airport Transfer' ? 'flight' : 'appointment';
            ...
            let actions;
            useActions ? actions = customActions :
                actions = new slack_block_models_1.ActionBlock(blocks_1.default.confirmTrip).addElements([
    ...
    getTripDetailsSelects(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            const destinationSelect = new slack_block_models_1.SelectElement(slack_block_models_1.ElementTypes.externalSelect, 'Select an embassy', 'destination');
            const pickupSelect = new slack_block_models_1.SelectElement(slack_block_models_1.ElementTypes.externalSelect, 'Select a pickup location', 'pickup');
    ...
    getFlightDetailsModal(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            const { pickupSelect, destinationSelect } = yield this.getDestinationSelection(payload);
            const pickup = new slack_block_models_1.InputBlock(pickupSelect, 'Pick-up Location', 'pickup');
            const destination = new slack_block_models_1.InputBlock(destinationSelect, 'Destination', 'destination');
            const flightNumber = new slack_block_models_1.InputBlock(new slack_block_models_1.TextInput('Enter flight number', 'flightNumber'), 'Flight Number', 'flightNumber');
            const defaultDate = moment_1.default().format('YYYY-MM-DD');
            const flightDate = new slack_block_models_1.InputBlock(new slack_block_models_1.DatePicker(defaultDate, 'select date', 'date'), 'Select Flight Date', 'date');
            const time = new slack_block_models_1.InputBlock(new slack_block_models_1.TextInput('HH:mm', 'time'), 'Time', 'time');
            const textarea = new slack_block_models_1.InputBlock(new slack_block_models_1.TextInput('Enter reason for booking the trip', 'reason', true), 'Reason', 'reason');
            return new slack_block_models_1.Modal('Flight Details', {
                submit: 'Submit',
                close: 'Cancel',
    ...
    getDestinationSelection(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const pickupSelect = new slack_block_models_1.SelectElement(slack_block_models_1.ElementTypes.externalSelect, 'Select a pickup location', 'pickup');
            const destinationSelect = new slack_block_models_1.SelectElement(slack_block_models_1.ElementTypes.staticSelect, 'Select destination', 'destination');

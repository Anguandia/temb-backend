...
class Interactions {
    ...
    sendContactDetailsModal(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            const modal = yield this.getContactDetailsModal(payload);
    ...
    getContactDetailsModal(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const departmentSelect = new slack_block_models_1.SelectElement(slack_block_models_1.ElementTypes.staticSelect, 'Select a department', 'department');
            departmentSelect.addOptions(this.newSlackHelpers.toSlackSelectOptions(departments, { textProp: 'name', valueProp: 'id' }));
            const rider = new slack_block_models_1.InputBlock(new slack_block_models_1.SelectElement(slack_block_models_1.ElementTypes.userSelect, 'Select a rider', 'rider'), 'For Who?', 'rider');
            const department = new slack_block_models_1.InputBlock(departmentSelect, 'Departments', 'department');
            const passengers = new slack_block_models_1.InputBlock(new slack_block_models_1.TextInput('Enter the total number of passengers', 'passengers'), 'Number of Passengers', 'passengers', false, 'e.g; 2');
            const riderPhoneNo = new slack_block_models_1.InputBlock(new slack_block_models_1.TextInput('Enter passenger\'s phone number', 'riderPhoneNo'), 'Passenger phone number', 'riderPhoneNo', false, 'e.g +250717665593');
            const travelTeamPhoneNo = new slack_block_models_1.InputBlock(new slack_block_models_1.TextInput('Enter travel team phone number', 'travelTeamPhoneNo'), 'Travel team phone number', 'travelTeamPhoneNo', false, 'e.g +250717665593');
            const modal = new slack_block_models_1.Modal('Contact Details', {
                submit: 'Submit',
                close: 'Cancel',
            }).addBlocks([rider, department, passengers, riderPhoneNo, travelTeamPhoneNo])
                .addCallbackId(actions_1.default.submitContactDetails)

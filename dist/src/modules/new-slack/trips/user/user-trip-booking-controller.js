...
const trip_helpers_1 = __importDefault(require("../user/trip.helpers"));
...
const itinerary_controller_1 = __importDefault(require("../../trips/user/itinerary.controller"));
...
class UserTripBookingController {
    ...
    static sendDestinations(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            const state = { origin: payload.response_url };
            const { homeBaseName } = yield cache_1.default.fetch(ScheduleTripInputHandlers_1.getTripKey(payload.user.id));
            const fields = yield slack_helpers_1.default.getDestinationFields(homeBaseName);
    ...
    static savePickupDetails(payload, submission, respond, context) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield interactions_1.default.sendPostPickUpMessage(payload, pickupDetails);
            }
            catch (err) {

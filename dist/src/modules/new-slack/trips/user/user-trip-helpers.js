...
class UserTripHelpers {
    ...
    static createContToDestMsg() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            continueBlock.addElements([
                new slack_block_models_1.ButtonElement(new slack_block_models_1.SlackText('Enter Destination'), 'select_destination', actions_1.default.sendDest, SlackMessageModels_1.SlackActionButtonStyles.primary)
            ]);
    ...
    static getPostPickupMessage(payload, submission) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static getPostDestinationMessage(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const message = payload.submission.destination !== 'Others'
                ...
                : yield this.getLocationVerificationMsg(payload.submission.othersDestination, payload.user.id, actions_1.default.selectDestinationLocation, actions_1.default.sendDest);

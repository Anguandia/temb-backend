...
class Interactions {
    ...
    static sendPostPickUpMessage(payload, submission) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = JSON.parse(payload.view.private_metadata);
            const message = yield user_trip_helpers_1.default.getPostPickupMessage(payload, submission);
            yield updatePastMessageHelper_1.default.newUpdateMessage(data.origin, message);
        });
    }
    static sendPostDestinationMessage(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            const message = yield user_trip_helpers_1.default.getPostDestinationMessage(payload);

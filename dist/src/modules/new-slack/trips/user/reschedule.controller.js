...
class RescheduleController {
    ...
    static storeReschedularInfo(payload, submission, respond, context) {
        try {
            const data = slack_helpers_1.default.modalValidator(submission, schemas_1.tripRescheduleSchema);
            respond.clear();
        }
        catch (err) {

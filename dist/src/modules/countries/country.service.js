...
class CountryService extends base_service_1.BaseService {
    ...
    deleteCountryByNameOrId(id = -1, name = '') {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const country = yield this.model.findOne({
                where: {
                    [sequelize_1.Op.or]: [{ id: findBy.id }, { name: { [sequelize_1.Op.iLike]: `${findBy.name}%` } }],
                },
            });
            errorHandler_1.default.throwErrorIfNull(country.get(), `Country named '${name}' was not found`, 404);

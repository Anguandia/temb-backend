...
const ReportGeneratorService_1 = __importDefault(require("../ReportGeneratorService"));
describe('Report Generator Service', () => {
    let reportService;
    const response = TripsDataMock_1.default;
    beforeAll(() => {
        reportService = new ReportGeneratorService_1.default(1);
    ...
    it('should raise an error on unsupported report type', () => {
        const willThrows = () => new ReportGeneratorService_1.default(undefined, 'unsupported');
    ...
    it('should raise an error on unsupported report type when set via property', () => {
        const willThrowAnotherError = () => {
            const err = new ReportGeneratorService_1.default(1);

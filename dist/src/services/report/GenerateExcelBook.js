...
class GenerateExcelBook {
    ...
    static populateSheetRowData(sheetRef, data, startColumn, startRow, isColHeader = false) {
    ...
    static fillSummaryData(summary, sheetRef) {
        ...
        departments.forEach((department) => {
            ...
            ['completed', 'declined', 'total'].forEach((property) => {
                currentColumn = GenerateExcelBook.fnFillDataRows(sheetRef, currentRow, summary, currentColumn, department, property);
            });
            currentRow += 1;
            currentColumn = startColumn;
        });
        GenerateExcelBook.fillTotalRows(currentRow, currentColumn, sheet, summary, startColumn);
    }
    static fillTotalRows(currentRowVal, currentColumnVal, sheetRef, summary, startColumn) {
        ...
        ['totalTripsCompleted', 'totalTripsDeclined', 'totalTrips'].forEach((property) => {
            currentColumn = GenerateExcelBook.fnFillTotalColumns(sheetRef, currentRow, summary, currentColumn, property);
        });

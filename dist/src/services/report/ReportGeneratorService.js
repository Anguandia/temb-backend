...
class ReportGeneratorService {
    ...
    static writeAttachmentToStream(workBook) {
    ...
    static getMonthlyTripsSummary(monthsBack) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static getOverallTripsSummary() {
        return __awaiter(this, void 0, void 0, function* () {
            const monthOneSummary = yield ReportGeneratorService.getMonthlyTripsSummary(1);
            const { totalTripsCompleted: monthTwoTripsCompleted } = yield ReportGeneratorService.getMonthlyTripsSummary(2);

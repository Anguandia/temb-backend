...
import RouteInputHandler from '../RouteInputHandler';
...
describe('continueWithFlow', () => {
  it('it should call the home route handler function', async (done) => {
    ...
    jest.spyOn(RouteInputHandler, 'home').mockResolvedValue({});
    await RouteInputHandlerHelper.continueWithTheFlow(payload, respond);
    expect(RouteInputHandler.home).toBeCalled();
    done();
  });
});

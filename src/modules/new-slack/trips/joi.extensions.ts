...
export const greaterThan = (joi: any) => {
    ...
    rules: [
      {
        ...
        validate(params: any, value: string, state: any, options: any) {
          ...
          if (value < prev) {
            return this.createError('string.greaterThan',
              { value, greaterThan: params.greaterThan }, state, options);
          }
          return value;
        },
      },
      {
        ...
        validate(params: any, value: string, state: any, options: any) {
          ...
          if (value > prev) {
            return this.createError('string.lessThan',
              { value, lessThan: params.lessThan }, state, options);
          }
          return value;
        },
      },

import database, { User, Cab, Driver, Provider } from '../../database';
import ProviderHelper from '../../helpers/providerHelper';
import { BaseService } from '../shared/base.service';
import RemoveDataValues from '../../helpers/removeDataValues';
import { DirectMessage } from '../../modules/providers/notifications/dm.notification';
import { EmailNotification } from '../../modules/providers/notifications/email.notification';
import { ChannelNotification } from '../../modules/providers/notifications/channel.notification';
import { WhatsAppNotification } from '../../modules/providers/notifications/whatsapp.notfication';
...
class ProviderService extends BaseService<Provider, number> {
  ...
  async findByPk(pk: number, withFks = false): Promise <object> {
    const provider = await this.findById(pk, withFks ? [
      { include: ['user'] },
    ] : []);
    return provider;
  }
